...
class User(Base):
    ...
    bankrolls: Mapped[list["Bankroll"]] = relationship("Bankroll", back_populates="user", cascade="all, delete-orphan")
    prediction_runs: Mapped[list["PredictionRun"]] = relationship(
        "PredictionRun", back_populates="user", cascade="all, delete-orphan"
    )
